...
class ROS_Daev:
    ...
    def __init__(self,racecar_name,model,height,width,decoupled=False,velocity =1.0):
        ...
        self.image_topic='zed/zed_node/left/image_rect_color/compressed'
        rospy.logwarn(model)
        ...
        if (not self.decoupled):
            ...
            self.pub=rospy.Publisher(racecar_name+'/angle_msg',angle_msg,queue_size=10)
    ...
    def image_callback(self,ros_image):
        ...
        try:
            orig_image=self.cv_bridge.compressed_imgmsg_to_cv2(ros_image,"bgr8")/255.0
...
if __name__=='__main__':
    ...
    image_sub=rospy.Subscriber(il.image_topic,CompressedImage,il.image_callback)
